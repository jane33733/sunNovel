					...
					<div id="card-element-781361" class="collapse">
						<div class="card-block">
							...
							<div class="form-group">
								<input type="text" id="newAccount" name="newAccount" value="haha" class="form-control">
								<button type="submit" id="newGameBtn" value="newGame" class="btn btn-primary fr">
								進入遊戲
								</button>
							</div>
						</div>
				...
				<div class="card">
					...
					<div id="card-element-550431" class="collapse">
						<div class="card-block">
							請輸入上次使用的遊玩帳號
							<div class="form-group">
								<input type="text" id="loadAccount" name="loadAccount" value="haha" class="form-control">
								<button type="submit" id="loadGameBtn" value="loadGame" class="btn btn-primary fr">
								載入遊戲
								</button>
							</div>				
						</div>
